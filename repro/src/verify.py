...
def main() -> int:
    ...
    result["claim_statuses"]["C6"] = c6["scientific_verdict"]
    result["environment"] = {
    ...
    print(f"C6_SCIENTIFIC_VERDICT={c6['scientific_verdict']}")
    cumulative_passed = (
